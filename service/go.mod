...
require (
	...
	github.com/keys-pub/keysd/http/api v0.0.0-20200321190416-76f894b5721b
	github.com/keys-pub/keysd/http/client v0.0.0-20200321190416-76f894b5721b
	github.com/keys-pub/keysd/http/server v0.0.0-20200321023318-57a4736fc930
	github.com/keys-pub/keysd/wormhole v0.0.0-20200321220344-23c2678e5f14
