...
require (
	...
	github.com/keys-pub/keysd/http/api v0.0.0-20200124061657-dc71bea457bb
	github.com/keys-pub/keysd/http/client v0.0.0-20200124061834-3fbebc18b9d4
	github.com/keys-pub/keysd/http/server v0.0.0-20200124061611-28a3a3362e7a
