...
func TestSecretBox(t *testing.T) {
	key := keys.Bytes32(encoding.MustHex("1b27556473e985d462cd51197a9a46c76009549eac6474f206c4ee0844f68389"))
	iv := keys.Bytes24(encoding.MustHex("69696ee955b62b73cd62bda875fc73d68219e0036b7a0b37"))
