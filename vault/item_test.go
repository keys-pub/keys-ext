...
func TestItem(t *testing.T) {
	...
	expected := `([]uint8) (len=74 cap=140) {
 00000000  85 a2 69 64 a8 61 63 63  6f 75 6e 74 31 a3 64 61  |..id.account1.da|
 ...
 00000030  00 3d 09 00 49 96 02 d2  a2 74 73 c7 0c ff 00 00  |.=..I....ts.....|
 00000040  00 00 ff ff ff f1 88 6e  09 00                    |.......n..|
}
`
